...
import cn.edu.pku.zy.adapter.WeatherPagerAdapter;
import cn.edu.pku.zy.bean.TodayWeather;
import cn.edu.pku.zy.bean.Weatherinfo;
import cn.edu.pku.zy.fragment.FirstWeatherFragment;
import cn.edu.pku.zy.fragment.SecondWeatherFragment;
import cn.edu.pku.zy.indicator.CirclePageIndicator;
...
public class MainActivity extends FragmentActivity implements View.OnClickListener,ViewPager.OnPageChangeListener {
    ...
    public void onClick(View view) {//点击事件
        ...
        void initView () {//初始化布局
            ...
            weekTv.setText("今天" + sharedPreferences.getString("week", "N/A"));
